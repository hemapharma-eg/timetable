            ...
            <>
              ...
              <form onSubmit={async (e) => {
                ...
                <div>
                  ...
                  <input name="email" type="email" required className="w-full px-4 py-2 bg-slate-900 border border-slate-700 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="your.email@university.edu" />
                </div>
              ...
              <div className="mt-6 text-center text-sm text-slate-400">
                <button type="button" onClick={() => setAuthMode('signIn')} className="text-indigo-400 hover:text-indigo-300 font-medium">← Back to Sign In</button>
              </div>
            </>
          ) : (
            <>
              ...
              <div className="mt-6 text-center text-sm text-slate-400">
                <button type="button" onClick={() => setAuthMode('forgotPassword')} className="text-indigo-400 hover:text-indigo-300 font-medium">Forgot your password?</button>
              </div>
              <p className="mt-4 text-center text-xs text-slate-500">Your account is created by your administrator.<br/>Contact admin if you don't have access.</p>
            </>
          )}
        </div>
      </div>
