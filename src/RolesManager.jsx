    ...
    <div className="flex flex-col h-full gap-6">
      ...
      <div className="flex bg-white p-1 rounded-xl shadow-sm border border-slate-200 w-fit">
        ...
        <button 
          ...
          className={`px-6 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'users' ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-500 hover:text-slate-800'}`}
        >
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 animate-in fade-in slide-in-from-bottom-2">
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center">
              <Shield className="mr-2 text-indigo-600" /> Manage Application Roles
            </h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 animate-in fade-in slide-in-from-bottom-2">
          <div className="mb-6 flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">Assign custom application roles to faculty members synced from Google Sheets.</p>
            </div>
